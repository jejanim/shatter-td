...
declare let bj_FORCE_ALL_PLAYERS: force
declare let bj_FORCE_PLAYER: force
declare let bj_MELEE_MAX_TWINKED_HEROES: number
declare let bj_mapInitialPlayableArea: rect
declare let bj_mapInitialCameraBounds: rect
...
declare let bj_slotControl: mapcontrol
declare let bj_gameStartedTimer: timer
declare let bj_gameStarted: boolean
declare let bj_volumeGroupsTimer: timer
declare let bj_isSinglePlayer: boolean
declare let bj_dncSoundsDay: trigger
declare let bj_dncSoundsNight: trigger
declare let bj_dayAmbientSound: sound
declare let bj_nightAmbientSound: sound
declare let bj_dncSoundsDawn: trigger
declare let bj_dncSoundsDusk: trigger
declare let bj_dawnSound: sound
declare let bj_duskSound: sound
declare let bj_useDawnDuskSounds: boolean
declare let bj_dncIsDaytime: boolean
declare let bj_rescueSound: sound
declare let bj_questDiscoveredSound: sound
declare let bj_questUpdatedSound: sound
declare let bj_questCompletedSound: sound
declare let bj_questFailedSound: sound
declare let bj_questHintSound: sound
declare let bj_questSecretSound: sound
declare let bj_questItemAcquiredSound: sound
declare let bj_questWarningSound: sound
declare let bj_victoryDialogSound: sound
declare let bj_defeatDialogSound: sound
declare let bj_stockItemPurchased: trigger
declare let bj_stockUpdateTimer: timer
...
declare let bj_meleeVisibilityTrained: trigger
declare let bj_meleeVisibilityIsDay: boolean
declare let bj_meleeGrantHeroItems: boolean
declare let bj_meleeNearestMineToLoc: location
declare let bj_meleeNearestMine: unit
...
declare let bj_ghoul: unit
declare let bj_crippledTimer: timer
declare let bj_crippledTimerWindows: timerdialog
declare let bj_playerIsCrippled: boolean
declare let bj_playerIsExposed: boolean
declare let bj_finishSoonAllExposed: boolean
declare let bj_finishSoonTimerDialog: timerdialog
declare let bj_meleeTwinkedHeroes: number
declare let bj_rescueUnitBehavior: trigger
declare let bj_rescueChangeColorUnit: boolean
declare let bj_rescueChangeColorBldg: boolean
declare let bj_cineSceneEndingTimer: timer
declare let bj_cineSceneLastSound: sound
declare let bj_cineSceneBeingSkipped: trigger
declare let bj_cineModePriorSpeed: gamespeed
...
declare let bj_cineFadeFinishTimer: timer
declare let bj_cineFadeContinueTimer: timer
...
declare let bj_queuedExecTriggers: trigger
declare let bj_queuedExecUseConds: boolean
declare let bj_queuedExecTimeoutTimer: timer
declare let bj_queuedExecTimeout: trigger
declare let bj_destInRegionDiesCount: number
declare let bj_destInRegionDiesTrig: trigger
declare let bj_groupCountUnits: number
declare let bj_forceCountPlayers: number
declare let bj_groupEnumTypeId: number
declare let bj_groupEnumOwningPlayer: player
declare let bj_groupAddGroupDest: group
declare let bj_groupRemoveGroupDest: group
declare let bj_groupRandomConsidered: number
declare let bj_groupRandomCurrentPick: unit
declare let bj_groupLastCreatedDest: group
declare let bj_randomSubGroupGroup: group
...
declare let bj_destRandomCurrentPick: destructable
declare let bj_elevatorWallBlocker: destructable
declare let bj_elevatorNeighbor: destructable
declare let bj_itemRandomConsidered: number
declare let bj_itemRandomCurrentPick: item
declare let bj_forceRandomConsidered: number
declare let bj_forceRandomCurrentPick: player
declare let bj_makeUnitRescuableUnit: unit
declare let bj_makeUnitRescuableFlag: boolean
declare let bj_pauseAllUnitsFlag: boolean
declare let bj_enumDestructableCenter: location
declare let bj_enumDestructableRadius: number
declare let bj_setPlayerTargetColor: playercolor
...
declare let bj_isUnitGroupInRectRect: rect
declare let bj_changeLevelShowScores: boolean
declare let bj_changeLevelMapName: string
declare let bj_suspendDecayFleshGroup: group
declare let bj_suspendDecayBoneGroup: group
declare let bj_delayedSuspendDecayTimer: timer
declare let bj_delayedSuspendDecayTrig: trigger
declare let bj_livingPlayerUnitsTypeId: number
declare let bj_lastDyingWidget: widget
declare let bj_randDistCount: number
declare let bj_randDistID: number
declare let bj_randDistChance: number
declare let bj_lastCreatedUnit: unit
declare let bj_lastCreatedItem: item
declare let bj_lastRemovedItem: item
declare let bj_lastHauntedGoldMine: unit
declare let bj_lastCreatedDestructable: destructable
declare let bj_lastCreatedGroup: group
declare let bj_lastCreatedFogModifier: fogmodifier
declare let bj_lastCreatedEffect: effect
declare let bj_lastCreatedWeatherEffect: weathereffect
declare let bj_lastCreatedTerrainDeformation: terraindeformation
declare let bj_lastCreatedQuest: quest
declare let bj_lastCreatedQuestItem: questitem
declare let bj_lastCreatedDefeatCondition: defeatcondition
declare let bj_lastStartedTimer: timer
declare let bj_lastCreatedTimerDialog: timerdialog
declare let bj_lastCreatedLeaderboard: leaderboard
declare let bj_lastCreatedMultiboard: multiboard
declare let bj_lastPlayedSound: sound
declare let bj_lastPlayedMusic: string
declare let bj_lastTransmissionDuration: number
declare let bj_lastCreatedGameCache: gamecache
declare let bj_lastCreatedHashtable: hashtable
declare let bj_lastLoadedUnit: unit
declare let bj_lastCreatedButton: button
declare let bj_lastReplacedUnit: unit
declare let bj_lastCreatedTextTag: texttag
declare let bj_lastCreatedLightning: lightning
declare let bj_lastCreatedImage: image
declare let bj_lastCreatedUbersplat: ubersplat
declare let filterIssueHauntOrderAtLocBJ: boolexpr
declare let filterEnumDestructablesInCircleBJ: boolexpr
declare let filterGetUnitsInRectOfPlayer: boolexpr
declare let filterGetUnitsOfTypeIdAll: boolexpr
declare let filterGetUnitsOfPlayerAndTypeId: boolexpr
declare let filterMeleeTrainedUnitIsHeroBJ: boolexpr
declare let filterLivingPlayerUnitsOfTypeId: boolexpr
